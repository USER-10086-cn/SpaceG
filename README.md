...
### 1- 简介
`LQ-ls2k301_LIB-V1.1.0`库，针对龙邱科技 龙芯2k301核心板常用外设资源和龙邱产品模块移植驱动例程，以方便参加智能车竞赛和使用我们产品的人入门学习使用，2k301和2k300基本上可以通用，仅内存形式不同、龙邱核心板与久久派引出引脚个别有所不同，故相关视频教程依旧可以参考龙邱2K300的。
...
3. 打开软件导入工程。
4. 项目介绍：
   - <font color="red">`LQ_ls2k301_LIB_V1.1.0`</font>是更新后的不带有测试例程的项目工程
